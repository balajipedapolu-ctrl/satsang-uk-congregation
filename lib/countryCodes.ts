...
// United Kingdom and India are pinned first (primary audience for this site),
// the rest follow alphabetically by country name.
...
/** Splits a stored phone value like "+91 98765 43210" into dial code + rest. */
export function splitPhone(value: string): { dial: string; number: string } {
  const trimmed = value.trim();
  const byDialLength = [...COUNTRY_CODES].sort(
